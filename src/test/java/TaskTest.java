...
public class TaskTest {
 ...
 //include Task.clear() at the beginning of the test. Again, this is very important. The list containing all Tasks will not automatically empty itself between each test.//
     @Test
